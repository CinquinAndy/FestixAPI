...
public class FestixApiApplication {
     ...
     */
    @Bean
    CommandLineRunner run(AdminRepository adminRepository, FestivalRepository festivalRepository, EventRepository eventRepository, ArtistRepository artistRepository) {
        return args -> {
            adminRepository.save(new Admin(null, "Andy", "Cinquin", "cinquin.andy@gmail.com", true));
            adminRepository.save(new Admin(null, "Albert", "Bernard", "albert.bernard@gmail.com", false));
            adminRepository.save(new Admin(null, "Albert1", "Bernard1", "albert.bernard1@gmail.com", false));
            adminRepository.save(new Admin(null, "Albert2", "Bernard2", "albert.bernard2@gmail.com", false));
            adminRepository.save(new Admin(null, "Albert3", "Bernard3", "albert.bernard3@gmail.com", false));
